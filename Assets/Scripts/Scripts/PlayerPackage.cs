...
public class PlayerPackage : MonoBehaviour
{
    ...
    public void LoadNextScene()
    {
        ...
        if (_dataRecorder != null && activeSceneType != SceneType.Excercise && activeSceneType != SceneType.Break && activeSceneType != SceneType.Puzzle)// && activeSceneType != SceneType.Neutral)
        {
